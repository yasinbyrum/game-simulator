    ...
    c.slotProbs.forEach((s, i) => {
        h += `<tr><td style="font-size:1.15rem;">Slot ${s.id}</td>
            <td><div style="display:flex; gap:2px;">
                <input class="edit" value="${s['b1'].R}" onchange="updateB1B2('chestConfigs[\`' + currentChestTab + '\`].slotProbs[${i}].',this.value, 'R')" style="width:30px; font-size:1.1rem;" title="R">
                <input class="edit" value="${s['b1'].P}" onchange="updateB1B2('chestConfigs[\`' + currentChestTab + '\`].slotProbs[${i}].',this.value, 'P')" style="width:30px; font-size:1.1rem;" title="P">
                <input class="edit" value="${s['b1'].C}" onchange="updateB1B2('chestConfigs[\`' + currentChestTab + '\`].slotProbs[${i}].',this.value, 'C')" style="width:30px; font-size:1.1rem;" title="C">
                <input class="edit" value="${s['b1'].L}" onchange="updateB1B2('chestConfigs[\`' + currentChestTab + '\`].slotProbs[${i}].',this.value, 'L')" style="width:30px; font-size:1.1rem;" title="L">
            </div></td>
            ${[3, 4, 5].map(b => `<td><div style="display:flex; gap:2px;"><input class="edit" value="${s['b' + b].R}" onchange="updateVal('chestConfigs[\`' + currentChestTab + '\`].slotProbs[${i}].b${b}.R',this.value)" style="width:30px; font-size:1.1rem;" title="R"><input class="edit" value="${s['b' + b].P}" onchange="updateVal('chestConfigs[\`' + currentChestTab + '\`].slotProbs[${i}].b${b}.P',this.value)" style="width:30px; font-size:1.1rem;" title="P"><input class="edit" value="${s['b' + b].C}" onchange="updateVal('chestConfigs[\`' + currentChestTab + '\`].slotProbs[${i}].b${b}.C',this.value)" style="width:30px; font-size:1.1rem;" title="C"><input class="edit" value="${s['b' + b].L}" onchange="updateVal('chestConfigs[\`' + currentChestTab + '\`].slotProbs[${i}].b${b}.L',this.value)" style="width:30px; font-size:1.1rem;" title="L"></div></td>`).join('')}
        </tr>`;
    });
